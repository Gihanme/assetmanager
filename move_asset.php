...
if ($user_details['user_level'] != "div_asset_clerk" and $user_details['user_level'] != 'asset_clerk'){
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
				...
				<td align="style="justify"><strong >&nbsp;&nbsp;Room </strong></td>
                    <td>
                    <select class="form-control" name="room" id="new_select">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-success btn-ok" type="submit" value="submit">OK</button>
                            </div>
                        </div>
                    </div>
                </div>		  
