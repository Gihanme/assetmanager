...
$user_details = $_SESSION['user_details']; $user_level = $log->retrieve_user_level_name($user_details['user_level']);
...
<script type="text/javascript" src="http://code.jquery.com/jquery-1.10.2.js"></script>  
  ...
  <link href="css/dxatatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
                ...
                <div class="left_col scroll-view">         
                    ...
                    <div class="profile">
                        ...
                        <div class="profile_info">
                            ...
                            <span>Welcome,</span>
                            <h2><?php echo $first_name;?></h2>               <span>(<?php echo $user_level;?>)</span>
                        </div>
                    </div>
                    <!-- /menu prile quick info -->
                    <!-- sidebar menu -->
        ...
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                <form name="createUserType" id="createUserType" method="post" action=""  data-toggle="validator">
