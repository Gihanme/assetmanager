...
if ($_SERVER["REQUEST_METHOD"] == "POST" ){
    ...
    $out = $log->asset_div_out($Division,$year);
    $in = $log->asset_div_in($Division,$year);
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <div>
                      ...
                      <select name="division" <?php if ($user_details['user_level'] == "div_asset_clerk"){echo "style='display:none' disabled";}?>>
                          <?php 
                          ...
                          <tbody>
                              ...
                              if (isset($out)){
                                  while ($data = $out->fetch_assoc()){
                                      echo "<tr><td>".$data['asset_id']."</td>"
                                              . "<td>".$data['old_room']."</td>"
                                              . "<td>".$data['new_division']."</td>"
                                              . "<td>".$data['new_room']."</td>"
                                              . "<td>".$data['verify_date']."</td></tr>";
                                  }
                              }
                              ?>
                          </tbody>
                  ...
                  <div>
                      ...
                      <table class="table table-bordered">
                          ...
                          <tbody>
                              <?php 
                              if (isset($in)){
                                  while ($data = $in->fetch_assoc()){
                                      echo "<tr><td>".$data['asset_id']."</td>"
                                              . "<td>".$data['old_division']."</td>"
                                              . "<td>".$data['old_room']."</td>"
                                              . "<td>".$data['new_room']."</td>"
                                              . "<td>".$data['verify_date']."</td></tr>";
                                  }
