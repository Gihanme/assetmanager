...
<body class="nav-md">
  ...
  <div class="container body">
    ...
    <li><a href="create_assettype.php"><i class="fa fa-bars"></i> Create Asset Type</a></li>
                <li><a href="assettypedetails.php"><i class="fa fa-bars"></i>View Asset Type</a></li></ul>
            </div>
                        ...
                        <tr class="success">
                            ...
                            if($result->num_rows > 0){
                                while($row= $result->fetch_assoc()){
                                    echo "<tr><td>".$row["asset_type_id"]."</td>"."<td>".$row["asset_type"]."</td>"."<td>".$row["type_description"]."</td>";
                                    echo "<td><a href='edit_assettype.php?id=".$row['asset_type_id']."'>Edit</a></td>";
                                    echo "<td><a href='delete_type.php?id=".$row['asset_type_id']."'>Delete</a></td><tr>";
                                }
                            }else{
                                echo "0 results";
                            }
