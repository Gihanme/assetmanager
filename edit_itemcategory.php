...
<body class="nav-md">
  <div class="container body">
    ...
    <li><a href="create_itemcategory.php"><i class="fa fa-tasks"></i> Create asset category</a></li>
                <li><a href="itemcategorydetails.php"><i class="fa fa-tasks"></i> View asset category</a></li></ul>
            </div>
